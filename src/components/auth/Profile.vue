        ...
        <form action="{{ route('profile.save') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
                <div class="w-1/3 bg-gray-100 p-8 hidden md:inline-block">
                    ...
                    <p class="text-xs text-gray-500">Update your basic profile information such as Email Address, Name,
                        and Image.</p>
                </div>
                <div class="md:w-2/3 w-full">
                    <div class="py-8 px-16">
                        <label for="name" class="text-sm text-gray-600">Username</label>
                        <input
            ...
            <div class="flex btn p-16 py-8 bg-gray-300 clearfix rounded-b-lg border-t border-gray-200">
