            ...
            <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                ...
                <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                    <form @submit.prevent="submit()">
                        <div class="flex flex-row items-center justify-center lg:justify-start m-auto">
                            <p class="text-lg mb-0 mr-4">Sign in with</p>
                            <button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light"
                                class="inline-block p-3 bg-teal-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-teal-700 hover:shadow-lg focus:bg-teal-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-800 active:shadow-lg transition duration-150 ease-in-out mx-1">
                                <!-- Facebook -->
                        ...
                        <div class="mb-6">
                            <input type="text" v-model="username" required
                                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-teal-600 focus:outline-none"
...
export default {
    ...
    methods: {
        submit() {
            this.axios.post("http://localhost:3000/user/login",{"username": this.username, "password": this.password})
            .then(res => {
                if(res.status === 200){
